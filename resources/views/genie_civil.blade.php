...
<main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url({{ asset('assets-app/img/breadcrumbs-bg.jpg') }});">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <h2>Génie civil & BTP</h2>
        <ol>
          <li><a href="{{ route('index') }}">Accueil</a></li>
          <li>Genie civil & BTP</li>
        </ol>
    ...
    <section id="alt-services-2" class="alt-services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-6 img-bg" style="background-image: url({{ asset('assets-app/img/hero-carousel/Travaux-Public-Couverture_1~2.jpg') }});" data-aos="zoom-in" data-aos-delay="100"></div>
        </div>
    ...
    <section id="alt-services" class="alt-services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          <div class="col-lg-6 img-bg" style="background-image: url({{ ('assets-app/img/hero-carousel/hero-carousel-1.jpg') }});" data-aos="zoom-in" data-aos-delay="100"></div>
